...
NotesRouter.post("/voice-note", protect, NoteController.createNoteFromVoice);
NotesRouter.post("/enhanced-note", protect, NoteController.generateEnhancedNote);
NotesRouter.post("/generate-image", protect, NoteController.generateImage);
