...
PdfRouter.get("/:id/summary", PdfController.getPdfSummary);
PdfRouter.get("/:id/chat/sessions", PdfController.getChatSessions);
PdfRouter.get("/:id/chat/sessions/:sessionId", PdfController.getChatSession);
PdfRouter.post("/:id/chat/sessions", PdfController.createChatSession);
PdfRouter.delete("/:id/chat/sessions/:sessionId", PdfController.deleteChatSession);
