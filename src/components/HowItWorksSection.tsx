  ...
  const steps = [
    {
      ...
      title: "Create & Write",
      description:
        "Use our rich text editor with highlighting, formatting, and image support to capture your thoughts beautifully.",
    ...
    },
    {
      ...
      description:
        "Tag, pin, and bookmark your notes. Find anything instantly with our powerful search functionality.",
    ...
    },
    {
      ...
      title: "Share & Export",
      description:
        "Download your notes as PDF or share them with others. Your knowledge, beautifully presented.",
    ...
    <section id="how-it-works" className="px-4 py-20 mx-auto max-w-7xl">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {steps.map((step, index) => (
          <div key={index} className="relative" data-aos="zoom-out-down">
