...
const HowItWorksSection = () => {
  const steps = [
    {
      step: "1",
      title: "Create & Write",
      description: "Start writing with our intuitive rich text editor. Add formatting, images, and structure your thoughts with professional-grade tools.",
    ...
    },
    {
      step: "2",
      title: "Voice Chat",
      description: "Activate the AI voice assistant to have natural conversations with your notes. Ask questions, get summaries, or find specific information instantly.",
    ...
    },
    {
      ...
      description: "Let AI analyze your notes to provide intelligent suggestions, connections between ideas, and actionable insights to enhance your productivity.",
  ...
  return (
    <section id="how-it-works" className="px-4 py-20 mx-auto max-w-7xl bg-gradient-to-br from-gray-50 to-white">
      <div className="text-center mb-16">
        ...
        <p
          ...
          data-aos-delay="100"
        >
          Experience the future of note-taking with our AI-powered workflow that adapts to your thinking process
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 relative">
        ...
        {steps.map((step, index) => (
          <div key={index} className="relative z-10" data-aos="fade-up" data-aos-delay={index * 200}>
              ...
              <CardContent className="pt-8 pb-6 text-center relative">
                ...
                <div className="relative z-10">
                  <div className="relative mx-auto mb-6 w-20 h-20">
                    {/* Step number circle */}
                    <div className={`absolute inset-0 ${step.iconBg} rounded-full flex items-center justify-center shadow-lg`}>
      ...
      <div className="mt-16 flex justify-center" data-aos="fade-up" data-aos-delay="600">
