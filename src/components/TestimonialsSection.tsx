...
const TestimonialsSection = () => {
  ...
  return (
    <section id="testimonials" className="px-4 py-20 mx-auto max-w-7xl bg-gradient-to-b from-white to-gray-50 overflow-hidden">
        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <CardContent className="pt-8 pb-6 relative z-10">
              ...
              {/* Testimonial with typing animation effect */}
      ...
      <div className="absolute bottom-20 right-10 w-16 h-16 bg-blue-100 rounded-full opacity-20 animate-pulse" style={{ animationDelay: '1s' }} />
      <div className="absolute top-1/2 left-1/4 w-12 h-12 bg-purple-100 rounded-full opacity-20 animate-pulse" style={{ animationDelay: '2s' }} />
    </section>
  );
};
